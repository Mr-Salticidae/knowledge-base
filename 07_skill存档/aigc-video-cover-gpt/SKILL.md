...
- **品牌信息**（可选）：是否有固定 IP 报头 / slogan（如「GenJi是真想教会你 / DEEP-LEVEL AI SCIENCE POPULARIZATION」）。
...
```
┌─────────────────────────────────────────────┐
│ [顶部品牌条·斜切色块] logo + 中文IP名   英文slogan │
│                                               │
...
3. **顶部品牌条可选**：蓝色/主题色斜切色块 + logo + 中文 IP 名，右上角放英文 slogan 全大写。
...
[4·文字内容·逐条列清] Render this exact text:
  ...
  - Top brand bar: "GenJi是真想教会你" with logo, English "DEEP-LEVEL AI SCIENCE POPULARIZATION" top-right.
