...
| dingtalk-doc-delivery | v1.1 | 2026-07-22 | 钉钉知识库文档交付:格式白名单(修饰只用加粗+代码块,禁引用块/表格)+ 四段式教程体例(成品/工具/步骤/总结)→ 导入母文档 → 过审终版 verbatim 回填 git | Claude | 实战6附件版一轮过审+终版回填;v2 四段式重排(对应 [[钉钉知识库交付_格式白名单与终版回填闭环_v1]]) |
