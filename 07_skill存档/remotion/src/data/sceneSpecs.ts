...
export const sceneSpecs: SceneSpec[] = [
  ...
  },
  {
    ...
    narration: '最后，我想记录一些个人看法。不感兴趣的话，现在可以酌情关闭视频了。有朋友问我：这个项目这么有价值，还要坚持开源吗？我的回答是：开源。而且是一定要开源。就要狠狠打字节的脸。因为，正如群星必须回归轨道，“无产阶级”的铡刀也终将落下。',
    narrationBeats: [
      ...
      { id: 'beat_05_face', startFrame: 370, durationInFrames: 70, text: '就要狠狠打字节的脸。', linkedSubjectIds: ['open_source'] },
