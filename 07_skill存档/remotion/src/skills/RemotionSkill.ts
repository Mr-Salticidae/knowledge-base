...
export type SceneAssetBinding = {
  sceneId: string;
  targetId?: string;
  assetType: 'svg' | 'image' | 'audio' | 'subtitle' | 'video' | 'placeholder';
  assetPath?: string;
...
export type CreateVideoStatus = 'planned' | 'rendering' | 'done' | 'error';
...
export const skillRegistry: SkillRegistryEntry[] = [
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\aigc-prompt-optimizer\\SKILL.md',
  ...
  },
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\prompt-master_v1.6.0_SKILL.md',
  ...
  },
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\blind-editing-workflow\\SKILL.md',
  ...
  },
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\suno-music-brief\\SKILL.md',
  ...
  },
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\character-consistency-mj\\SKILL.md',
  ...
  },
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\content-publish-sop\\SKILL.md',
  ...
  },
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\aigc-postmortem\\SKILL.md',
  ...
  },
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\ai-short-film-breakdown\\SKILL.md',
  ...
  },
  {
    ...
    skillPath: 'D:\\AIGC工作站\\知识库\\07_skill存档\\remotion\\SKILL.md',
  ...
  async () => {
    ...
    return {
      ...
      logs: [
        ...
        `当前阶段仅登记调用入口，不直接 Read 或执行外部 Skill。`,
...
export const createVideo = async (params: CreateVideoParams): Promise<CreateVideoResult> => {
  ...
  try {
    ...
    const assets = skillResults.flatMap((result) => result.assets ?? []);
