...
10. **日常题可做尺度跃迁**——当题眼物件太常见时，尝试把它转译成彗星、潮汐、云层、山体、城市事件等宏观现象；关键是保留物件特征和物理痕迹，让观众一眼看懂"它是什么"，第二眼感到"它不该这么大"。
11. **具体物件可地貌化**——当题眼物件有可读结构时，让它成为微型世界的山脊、山谷、桥、广场或洞穴；用 LEGO / 玩具沙盘 / 微缩摄影降低危险感，并让角色实际攀爬、探索、定居或围观。
