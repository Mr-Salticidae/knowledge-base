...
- 能把题眼物件升级成自然现象、天体事件或物理过程，但仍保留原物件的可识别特征；
- 能把题眼物件变成微型社会可进入、可攀爬、可探索的地貌或公共空间；
- 比常见符号少撞车。
...
| 没有故事感 | 加 `foreground-midground-background layering / subject looking away / environmental framing` |
