...
```text
1. 连续片段分镜表
2. 每个关键分镜的 Midjourney prompt
3. 用户生成并提供 MJ 关键图
4. 每张图对应的 Seedance 2.0 prompt
5. 用户生成并提供 Seedance 视频分镜
6. Eleven v3 连续 TTS
...
- Eleven v3 生成连续旁白,并且 Remotion 时间线要按真实音频时长对齐字幕;
...
```text
1. 连续旁白文案
2. Eleven v3 生成的真实音频文件
3. 每段音频的 duration / startFrame timing
4. Remotion 中按 timing 挂载 Audio 和字幕
```
