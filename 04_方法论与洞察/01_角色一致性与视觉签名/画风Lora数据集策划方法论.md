...
- 主线项目：`{AIGC工作站}/Lora_GAZE_数据集\`（31 张数据集）
- 数据集元数据：`{AIGC工作站}/Lora_GAZE_数据集\_meta\进度看板.md` / `筛选日志.md` / `prompts.md`
- 起点 prompt 模板：`{AIGC工作站}/Lora_GAZE_数据集\Lora数据集补图_MJ模板.md`（工作区根）
- 转交文档：`{AIGC工作站}/Lora炼制项目转交文档.md`（项目背景与决策）
