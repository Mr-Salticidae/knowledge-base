...
### ⭐⭐ 二次验证 + 扩展(2026-08-05 · Project Panama 案)

微博爆款帖"AI 公司买绝版书→切书脊→扫描→销毁原件"(1.5 万赞)复用本法查证,**三步全部适用,并逼出两条扩展**:

- **第一步"找原始来源"要放宽**:一手来源不止论文——本案是**解封的法庭文件**(4000+ 页)+《华盛顿邮报》调查。判据不变:**能不能落到不经二传的原始材料**。
- **第二步"查评审状态"泛化为"查证据等级"**:预印本 vs 同行评审,对应到本案是**法庭认定的事实 vs 匿名书商的转述**。同一条帖子里两种等级混着放,是最常见的障眼法。
- 🆕 **扩展第四步:分清"哪部分被证实、哪部分未证实"。** 本案与 PsAIch 案的差异在于——PsAIch 是"引语真、解读假";Project Panama 是 **"主体全真,但最戳人的那一句恰恰未证实"**(Project Panama、内部原话、15 亿和解全部坐实;而"珍稀孤本被销毁"至今无一例经核实)。
  - 这类帖子更危险:因为可核实的部分足够扎实,读者会把未证实的部分**一并当真**。
  - 操作:转发/引用时,**未证实的那句必须带着"未证实"一起转**,否则你就是这条信息链上出错的一环。
- **反向教训**:本案传播中**被淹没的恰恰是真正被判违法的部分**(700 万本盗版书 → 15 亿美元和解)。画面冲击力最强的环节,未必是事实上最严重的环节——**查证还要问"最严重的是不是被最少讨论的那个"**。

完整案例与压缩层结论见 [[压缩保留簇丢弃孤例_v1]]。
...
- **三步查证法的第二个案例**:[[压缩保留簇丢弃孤例_v1]] —— Project Panama 实体书销毁帖查证;逼出第四步「分清哪部分被证实/哪部分未证实」与「最严重的常是被最少讨论的」两条扩展 ⭐⭐
